...
study is indeed existent or whether it is just a spurious finding? The answer to
such questions is of high importance to researchers, decision makers, and the
general population, and one way to address them scientifically is through
\emph{replication studies}.

A replication study consists of repeating the original study as closely as
possible but with new subjects. Such a study may yield similar results which
would make us more confident about the original finding, or may yield
conflicting results which would lower our confidence. As such, replication
studies are an essential part of the scientific method as they provide a means
for substantiating genuine research findings and refuting research findings
which occurred merely by chance. For this reason, ``successful'' replication is
often a requirement, for instance, for acceptance of newly proposed scientific
...
replication studies may hence have real world consequences, % , such as deciding
...
and it is therefore important that methodological aspects of replication

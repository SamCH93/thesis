...
other definitions of statistical evidence and in latter parts of this thesis
(Paper\ref{PaperII} and Paper\ref{PaperIV}) we will extend this reverse-Bayes
procedure to employ alternative measures of evidence, such as Bayes factors.
...
thesis (Paper~\ref{PaperII} and Paper~\ref{PaperIV}).
...
The last part (Paper~\ref{PaperVI}) is about integrity issues in methodological
...
archived \url{https://doi.org/10.5281/zenodo.XXXXXXX}.

...
\caption{Schematic illustration of a comparative simulation study for evaluating
  ...
  study in Section~\ref{sec:study}. Questionable research practices (in gray)
...
\begin{figure}[!htb]
  ...
  \caption{Differences in Brier score with 95\% adjusted confidence intervals
    ...
    test observations; for details see Appendix~\ref{appendix:protocol}). The
    ...
    confidence intervals. } \label{fig:E1}
\end{figure}

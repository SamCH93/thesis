...
though the effect estimate from the replication is substantially smaller than
the effect estimate from the original study. % , which cannot happen with the sceptical
% Bayes factor.

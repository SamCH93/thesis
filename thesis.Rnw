...
\addtocontents{toc}{%
  \protect\vspace{2ex}
  \textbf{\textsf{Design and analysis of replication studies}\protect\texorpdfstring{ \protect\dotfill}{}}
  \par}
...
\paperchapter{%
  ...
  2022. arXiv preprint. \url{https://doi.org/10.48550/arXiv.2211.02552}.}
\include{paper3}

\addtocontents{toc}{\bigskip}
\addtocontents{toc}{%
  \protect\vspace{2ex}
  \textbf{\textsf{Reverse-Bayes methodology}\protect\texorpdfstring{ \protect\dotfill}{}}
  \par}
...
\addtocontents{toc}{%
  \protect\vspace{2ex}
  \textbf{\textsf{Integrity in methodological research}\protect\texorpdfstring{ \protect\dotfill}{}}
  \par}
...
\paperchapter{%
 Pitfalls and Potentials in Simulation Studies
  ...
  2022. arXiv preprint. \url{https://doi.org/10.48550/arXiv.2203.13076}.}

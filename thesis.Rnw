...
\hypersetup{
  ...
  citecolor = {Blue},
  urlcolor = {Blue},
  pdftitle = {Reverse-Bayes Methods for Replication Studies and Beyond},
...
\paperchapter{%
  ...
  2022. arXiv preprint. \href{https://doi.org/10.48550/arXiv.2211.02552}{doi:10.48550/arXiv.2211.02552}
}
\include{paper3}
...
\addtocontents{toc}{%
  \protect\vspace{2ex}
  \textbf{\textsf{Integrity in methodological research}}\par}
\addtocontents{toc}{%
  \protect\vspace{-2ex}
  \par\noindent\rule{\textwidth}{0.4pt}\par}
...
% \paperchapter{%
% Multivariate reverse-Bayes analysis
% \label{app:multiRB}
% }{%
%  Samuel Pawel
% }{}
...
% \paperchapter{%
% Reverse-Bayes asssessment of multiple replications
% \label{app:multipleRB}
% }{%
%  Samuel Pawel
% }{}

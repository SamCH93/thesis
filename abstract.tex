...
conflict between the sceptical prior and the replication data. The procedure can
be summarized in a single quantitative measure, termed the sceptical $p$-value.
% extension 1
...
though the effect estimate from the replication is arbitrarily smaller than
...
broader scope of applications than replication studies as in the first part. The
